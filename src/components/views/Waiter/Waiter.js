  ...
  renderActions(table, status){
    ...
    switch (status) {
      case 'free':
        return (
          <>
            <Button onClick={() => fetchChangeStatus(table, 'thinking')}>thinking</Button>
      ...
      case 'ordered':
        return (
          <Button onClick={() => fetchChangeStatus(table, 'prepared')}>prepared</Button>
        );
      case 'prepared':
        return (
          <Button onClick={() => fetchChangeStatus(table, 'delivered')}>delivered</Button>
        );
      case 'delivered':
        return (
          <Button onClick={() => fetchChangeStatus(table, 'paid')}>paid</Button>
        );
      case 'paid':
        return (
          <Button onClick={() => fetchChangeStatus(table, 'free')}>free</Button>
        );
      default:
        return null;
    }
